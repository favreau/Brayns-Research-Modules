...
#include "SpherePerspectiveCamera.h"
#include <limits>
// ispc-side stuff
#include "SpherePerspectiveCamera_ispc.h"
...
namespace ospray
{
SpherePerspectiveCamera::SpherePerspectiveCamera()
{
    ispcEquivalent = ispc::SpherePerspectiveCamera_create(this);
}

void SpherePerspectiveCamera::commit()
{
    Camera::commit();
    ...
    ispc::SpherePerspectiveCamera_set(
...
OSP_REGISTER_CAMERA(SpherePerspectiveCamera, circuit_explorer_sphere_clipping);
